...
<?php
    ...
    if(isset($loginSession) AND isset($passwordSession) ){
        ...
        if($loginSession==="admin" and $passwordSession==="admin"){   //si admin
            header('Location:http://localhost/Livre-or/admin.php'); //redirigé vers la page admin
        }
 ...
 <ul id="nav">
        ...
        <?php 
            ...
            if (!empty($loginSession) ){
                echo "<li><a class=","active"," href=",'/Livre-or/profil.php',">Bienvenue ",$loginSession,"</a></li>"; //affiche bienvenu $Utilisateur
